...
const Creator = ({campaignDetails, chatSession}) => {
    ...
    return (
        <div className="h-dvh">
			...
			>
				<FlyerEditor setMediaMode={setMediaMode} mediaModes={mediaModes} mediaMode={mediaMode} status={status} campaignDetails={localCampaignDetails} switchToVertical={switchToVertical} isMobile={isMobile}  />
				<AIAssistant chatLog={chatLog} setChatLog={setChatLog} mediaMode={mediaMode} setStatus={setStatus} setCampaignDetails={setLocalCampaignDetails} campaignDetails={localCampaignDetails} switchToVertical={switchToVertical} chatSession={chatSession}/>
			</div>
        </div>
    );
};
